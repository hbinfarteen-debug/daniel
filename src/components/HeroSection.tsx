...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      ref={sectionRef}
      className="relative w-full overflow-hidden min-h-[600px] py-28 md:py-36"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-arctic-deep-navy via-arctic-deep-navy/70 to-transparent" />
      {/* Accent line at bottom edge */}
      <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-arctic-ice-blue/50 to-transparent" />
      ...
      <motion.div
        ...
        className="relative z-10 flex h-full items-center pl-[calc(2.5rem+30px)] pr-10 md:pl-[calc(5rem+30px)] md:pr-20"
      >
        <motion.div
          variants={stagger}
          initial="hidden"
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="mt-3 text-[clamp(2.25rem,5vw,3.75rem)] font-[800] leading-[0.98] text-white sm:mt-4 sm:leading-[1.02]"
          >
            WHEN THE COOLING
            <br />
            STOPS,{' '}
          ...
          <motion.p
            variants={fadeUp}
            className="mt-4 text-[17px] leading-relaxed text-white/75 sm:mt-5 sm:text-lg sm:leading-[1.6]"
          >
          ...
          >
            ...
            <Button
              asChild
              size="lg"
              className="group h-14 w-full gap-2.5 bg-[#168FFF] px-7 text-[15px] font-semibold text-white shadow-lg shadow-[#168FFF]/25 transition-all duration-300 hover:bg-[#4AB5FF] hover:shadow-xl hover:shadow-[#4AB5FF]/30 sm:w-auto sm:px-9 sm:text-base"
            >
              <a
                href={WA_URL}
                target="_blank"
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="group h-14 w-full gap-2.5 border-white/25 bg-white/5 px-7 text-[15px] font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-white/50 hover:bg-white/10 sm:w-auto sm:px-8 sm:text-base"
            >
          ...
          {/* Trust strip — divider + badges */}
          <motion.div
            variants={fadeUp}
            className="mt-8 hidden sm:mt-10 sm:block"
          >
